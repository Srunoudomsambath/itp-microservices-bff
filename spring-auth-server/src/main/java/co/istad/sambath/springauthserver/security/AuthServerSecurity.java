package co.istad.sambath.springauthserver.security;
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http)
        ...
        http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers("/userinfo").authenticated() // Require authentication for userinfo
...
//    }
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient pkceClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("pkce-client")  // Match your AUTH_CLIENT_ID
                .clientAuthenticationMethod(ClientAuthenticationMethod.NONE)
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
                .authorizationGrantType(AuthorizationGrantType.REFRESH_TOKEN)
//                .redirectUri("http://localhost:8889/login/oauth2/code/pkce-client")
...
//                .scope(OidcScopes.OPENID)
//                .scope(OidcScopes.PROFILE)  // Add this
//                .scope(OidcScopes.EMAIL)    // Add this
//    //                .scope(OidcScopes.PROFILE)
